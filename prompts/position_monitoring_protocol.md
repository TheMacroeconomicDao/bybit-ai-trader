...
## CALL-TO-ACTION SCRIPTS (Для вовлечения пользователя)

Используй эти фразы чтобы привлечь внимание к критическим событиям:

### 🔴 Critical Warning
```
"⚠️ **ВНИМАНИЕ! Цена подходит к Stop Loss!**
Осталось 0.5% до уровня выхода.
Пожалуйста, проверь график!

Рекомендую: Приготовиться к выходу или (если есть веская причина) проверить не изменилась ли структура."
```

### 🟢 Profit Taking
```
"💰 **ОТЛИЧНО! Первая цель (TP1) достигнута!**
Прибыль: +3.5%

Рекомендую:
1. Зафиксировать 50% позиции сейчас.
2. Перевести Stop Loss в безубыток.
...
### 🟡 Stagnation Check
```
"⏳ **Позиция движется медленнее ожидаемого.**
Прошло 6 часов, прогресс всего 15%.

Рекомендую:
Установить таймер на 1 час. Если движения не будет — лучше закрыть и освободить капитал.
Что думаешь?"
```
